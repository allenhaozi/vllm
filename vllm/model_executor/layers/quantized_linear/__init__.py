...
from vllm.model_executor.layers.quantized_linear.squeezellm import (
    SqueezeLLMColumnParallelLinear,
    SqueezeLLMRowParallelLinear,
)
...
_QUANTIZED_LINEAR_REGISTRY = {
    ...
    "squeezellm": (SqueezeLLMColumnParallelLinear, SqueezeLLMRowParallelLinear, None),
}
...
class Linear:
    ...
    def linear(cls, *args, **kwargs) -> nn.Module:
        ...
        if (
            name not in _QUANTIZED_LINEAR_REGISTRY
            or _QUANTIZED_LINEAR_REGISTRY[name][2] is None
        ):
