...
class QWenLMHeadModel(nn.Module):
    ...
    def forward(
        ...
        # NOTE: We use nan_to_num to avoid NaNs in the hidden states.
    ...
    def load_weights(
        ...
        column_parallel_weights, row_parallel_weights = get_parallel_weight(self)
        ...
        for name, loaded_weight in hf_model_weights_iterator(
            ...
            if "c_attn" in name and any(
                name.endswith(suffix) for suffix in column_weight_suffixes
            ):
            ...
            for stride_id, weight_name in enumerate(["w2", "w1"]):
                ...
                if any(name.endswith(suffix) for suffix in column_weight_suffixes):
